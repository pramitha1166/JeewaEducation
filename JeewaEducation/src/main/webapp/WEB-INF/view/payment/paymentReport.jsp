<%@page import="com.graymatter.demo.model.CompanyExpences"%>
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<a href="${'/incomeList/pdf' }" style="margin-left: 62%;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Download The Income Report</a>
					<a href="${'/expenceList/pdf' }" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Download The Expense Report</a>
					<br><br>
					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Financial
								Report</h6>
						</div>
								...
								<div class="wrap-table100">
									...
									<div class="table100 ver2 m-b-110">
										...
										<div class="table100-body js-pscroll">
											<table>
												<tbody>
												<c:forEach var="PaymentReportI" items="${paymenreporttincomelist}">
													<tr class="row100 body">
														<td class="cell100 column1">${PaymentReportI.type}</td>
														<td class="cell100 column2">${PaymentReportI.amount}</td>
													</tr>
												</c:forEach>
												</tbody>
											</table>
									...
									<div class="table100 ver2 m-b-110">
										<div class="table100-head">
											<table>
												<thead>
													<tr class="row100 head">
														<th class="cell100 column1">Expenses</th>
														<th class="cell100 column2"></th>
													</tr>
												</thead>
											</table>
										...
										<div class="table100-body js-pscroll">
											<table>
												<tbody>
												<c:forEach var="PaymentReportE" items="${paymentreportexpencelist}">
													<tr class="row100 body">
														<td class="cell100 column1">${PaymentReportE.type}</td>
														<td class="cell100 column2">${PaymentReportE.amount}</td>
											...
											<table>
												<tbody>
													...
													<tr class="row100 body">
														...
														<td class="cell100 column1">Total Expense</td>
	...
	<!-- Page level plugins -->
	<script
		src="../static/admin/vendor/datatables/jquery.dataTables.min.js"></script>
	<script
